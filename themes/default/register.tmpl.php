...
<fieldset class="group_form"><legend class="group_form"><?php echo $this->title; ?></legend>
	...
	<table class="form-data" align="center">
		...
		<tr>
			...
			<td align="left"><input id="login" name="login" type="text" maxlength="20" size="30" value="<?php if (isset($_POST['login'])) echo htmlspecialchars($_POST['login']); else echo htmlspecialchars($this->user_row['login']); ?>" /></td>
		</tr>
		...
		<tr>
			...
			<td align="left"><input id="email" name="email" type="text" size="50" maxlength="50" value="<?php if (isset($_POST['email'])) echo htmlspecialchars($_POST['email']); else echo htmlspecialchars($this->user_row['email']); ?>" /></td>
		</tr>
...
<?php } ?>
		<tr>
			...
			<td align="left"><input id="first_name" name="first_name" type="text" value="<?php if (isset($_POST['first_name'])) echo htmlspecialchars($_POST['first_name']); else echo htmlspecialchars($this->user_row['first_name']); ?>" /></td>
		</tr>
		...
		<tr>
			...
			<td align="left"><input id="last_name" name="last_name" type="text" value="<?php if (isset($_POST['last_name'])) echo htmlspecialchars($_POST['last_name']); else echo htmlspecialchars($this->user_row['last_name']); ?>" /></td>
		</tr>
