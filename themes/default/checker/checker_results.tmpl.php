...
?>
	...
	<fieldset class="group_form">
        ...
        <legend class="group_form"><?php echo _AC("quality_review"); ?></legend>
        <h3><?php echo _AC("usability_accessibility_review") . ' ('. _AC("guidelines"). ': '.$this->guidelines_text. ')'; ?></h3>

<!-- BEGIN Added By Joel Carvalho -->
		<h4><i>
			<?php
				echo $this->uri.' on '.$this->combined_name;
			?>
		</i></h4>
        <h4>
            <?php
                $nAccProblems=$this->num_of_total_a_errors;
                echo $nAccProblems.' '._AC("problems_found");
            ?>
        </h4>
<!-- END Added By Joel Carvalho -->
...
<!-- Begin By Joel Carvalho -->
<script>
    $(document).ready(function() {
        $('.error-more').hide();
        $('.extra-info').show();
        $('.helpwanted').css('float','left');
        $('li.msg_err, li.msg_info').css('font-size','100%');
    });
</script>
<!-- End By Joel Carvalho -->