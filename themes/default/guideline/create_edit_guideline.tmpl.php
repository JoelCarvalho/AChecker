	...
	<table class="data" rules="rows" >
		...
		<tr>
			<th align="left"><input type="checkbox"
			   value="<?php echo _AC('select_all'); ?>" id="all_del_<?php echo $prefix;?>"
			   title="<?php echo _AC('select_all'); ?>" name="selectall_delchecks_<?php echo $prefix;?>"
			   onclick="CheckAll('del_checks_id_<?php echo $prefix; ?>[]','selectall_delchecks_<?php echo $prefix;?>');" /></th>
			<th align="left"><?php echo _AC('abbr'); ?></th>
			<th align="left" width="100px"><?php echo _AC('html_tag'); ?></th>
			<th align="left"><?php echo _AC('error_type'); ?></th>
			<th align="left" width="600px"><?php echo _AC('description'); ?></th>
			<th align="left" width="40px"><?php echo _AC('id'); ?></th>
			<th align="left" width="70px"><?php echo _AC('actions'); ?></th>
		</tr>
		</thead>
...
<?php foreach ($checks_array as $check_row) { ?>
		<tr onmousedown="rowselect(this);" onkeydown="rowselect(this);"
		    id="rdel_checks_<?php echo $prefix.'_'.$check_row['check_id']; ?>">
			<td><input type="checkbox"
					   name="del_checks_id_<?php echo $prefix;?>[]"
					   value="<?php echo $prefix.'_'.$check_row['check_id']; ?>"
					   id="del_checks_<?php echo $prefix.'_'.$check_row['check_id']; ?>"/></td>
			...
			<td><label for="del_checks_<?php echo $prefix.'_'.$check_row['check_id']; ?>"><?php echo htmlspecialchars(_AC($check_row['name'])); ?></label></td>
			<td><?php echo $check_row['check_id']; ?></td>
			<td>
				<a title="<?php echo _AC("info");?>" style="cursor: pointer" onclick="AChecker.popup('<?php echo AC_BASE_HREF; ?>checker/suggestion.php?id=<?php echo $check_row["check_id"]; ?>'); return false;">
					<img alt="<?php echo _AC("info");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/guide2.png" />
				</a>
				<a title="<?php echo _AC("edit");?>" style="cursor: pointer" onclick="AChecker.popup('<?php echo AC_BASE_HREF; ?>check/check_create_edit.php?id=<?php echo $check_row["check_id"]; ?>'); return false;">
					<img alt="<?php echo _AC("edit");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/edit.png" />
				</a>
				<a style="cursor: pointer" title="<?php echo _AC("edit_function");?>" onclick="AChecker.popup('<?php echo AC_BASE_HREF; ?>check/check_function_edit.php?id=<?php echo $check_row["check_id"]; ?>'); return false;">
...
<?php if (isset($this->row)) {?>
	<h2>
		<?php echo _AC('checks');?>
		<a href="<?php echo AC_BASE_HREF; ?>guideline/add_edit_group.php?action=add&amp;gid=<?php echo $this->gid; ?>"
		...
		<img alt="<?php echo _AC("add_group");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/add_group.png" />
		</a>
		<a href="<?php echo AC_BASE_HREF; ?>check/index.php?list=guideline&amp;gid=<?php echo $this->gid; ?>"
		...
		<img alt="<?php echo _AC("add_checks_into_guideline");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/add.png" />
		</a>
	</h2><br/>
<?php 
	...
	?>
		<h3 style="width:100%">
			<?php echo '['.$group['abbr'].'] '._AC($group['name']);?>
			...
			<img alt="<?php echo _AC("add_subgroup");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/add_group.png" />
			</a>
			...
			<img alt="<?php echo _AC("add_checks_into_group");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/add.png" />
			</a>
			...
			<img alt="<?php echo _AC("edit_group_name");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/edit.png" />
			</a>
			...
			<img alt="<?php echo _AC("del_this_group");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/delete.png" />
			</a>
		</h3><br/>
	<?php
	...
	?>
		<h4>
			<?php echo '['.$subgroup['abbr'].'] '._AC($subgroup['name']);?>
			...
			<img alt="<?php echo _AC("add_checks_into_subgroup");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/add.png" />
			</a>
			...
			<img alt="<?php echo _AC("edit_subgroup_name");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/edit.png" />
			</a>
			<a href="<?php echo AC_BASE_HREF; ?>guideline/create_edit_guideline.php?id=<?php echo $gid?>" 
			       title="<?php echo _AC('del_this_subgroup'); ?>" 
			       onclick="return del('gsg', <?php echo $subgroup['subgroup_id']; ?>)" >
			<img alt="<?php echo _AC("del_this_subgroup");?>" src="themes/<?php echo $_SESSION['prefs']['PREF_THEME']; ?>/images/delete.png" />
			</a>
		</h4><br/>
	<?php 
