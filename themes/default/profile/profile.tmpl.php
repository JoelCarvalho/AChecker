...
<fieldset class="group_form"><legend class="group_form"><?php echo _AC('edit_profile'); ?></legend>
	...
	<table class="form-data" align="center">
		...
		<tr>
			...
			<td align="left"><?php echo htmlspecialchars($_POST['login']); ?></td>
		</tr>
		...
		<tr>
			...
			<td align="left"><input id="first_name" name="first_name" type="text" value="<?php echo htmlspecialchars($_POST['first_name']); ?>" /></td>
		</tr>
		...
		<tr>
			...
			<td align="left"><input id="last_name" name="last_name" type="text" value="<?php echo htmlspecialchars($_POST['last_name']); ?>" /></td>
		</tr>
