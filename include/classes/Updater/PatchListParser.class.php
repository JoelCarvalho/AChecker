...
class PatchListParser {
    ...
    {
        if ($this->element_path == array('patch_list', 'patch', 'achecker_patch_id')) {
            $this->patch_rows[$this->row_num]['achecker_patch_id'] = trim($this->character_data);
