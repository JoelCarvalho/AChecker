...
class GuidelineSubgroupsDAO extends DAO {
    ...
    /**
     * Get Sub Group from specified abbreviation
     * @access      public
     ...
     */
    public function getSubgroupByAbbr($abbr){
        $sql = "SELECT * FROM " . TABLE_PREFIX . "guideline_subgroups
     ...
     * @access      public
     * @param       int $groupID
     * @param       string $abbr Sub Group Abbreviation
     * @return      mixed return retrieved rows, true for non-select sql and false if fail
     * @author      Joel Carvalho
     * @version     1.6.3 20/09/2015
     */
    public function getSubgroupByHierarchyAbbr($groupID, $abbr){
        $groupID = intval($groupID);
        $sql = "SELECT * FROM " . TABLE_PREFIX . "guideline_subgroups
                 WHERE abbr LIKE '".trim($abbr)."'
     ...
     * @version     1.6.3 20/09/2015
     */
    public function getSubgroupsByGroupID($groupID) {
        $groupID = intval($groupID);
        $sql = "SELECT * FROM " . TABLE_PREFIX . "guideline_subgroups
                 WHERE group_id = " . $groupID;
