...
class UsersDAO extends DAO
{
    ...
    public function Create($user_group_id, $login, $pwd, $email, $first_name, $last_name, $status) {
        ...
        $login = $this->db->real_escape_string(strtolower(trim($login)));
        $pwd = $this->db->real_escape_string($pwd);
        $email = $this->db->real_escape_string(trim($email));
        $first_name = $this->db->real_escape_string(str_replace('<', '', trim($first_name)));
        $last_name = $this->db->real_escape_string(str_replace('<', '', trim($last_name)));
    ...
    public function getUserByWebServiceID($webServiceID) {
        ...
        $webServiceID = $this->db->real_escape_string($webServiceID);
