<?php namespace QChecker\ExportRpt;
/************************************************************************/
...
{VALIDATION}
    ...
    var $html_summary =
        '<span style="background-color: {COLOR}; color: {COLOR2}; border: solid green; padding-right: 1em; padding-left: 1em">{SUMMARY}</span>&nbsp;&nbsp;
...
<div id="{DIV_ID}" style="margin-top:1em">
    ...
    public function    getHTMLfile($problem, $_gids, $errors, $user_link_id)
    {
        ...
        $detail = '<h3>' . _AC("quality_review") . '</h3>' . "\n";
    ...
    private function getSummaryStr($problem)
    {
        ...
        if ($problem == 'html' || $problem == 'css') {
            ...
            return str_replace(array('{COLOR}', '{COLOR2}', '{SUMMARY}', '{SUMMARY_DETAIL}'),
