...
if (isset($_GET['test'])) {
	...
	header('AChecker-Get: OK');
	exit;
}
$in_get = TRUE;

require(AC_INCLUDE_PATH . 'vitals.inc.php');
require(AC_INCLUDE_PATH . 'lib/mime.inc.php');
...
$file = AC_TEMP_DIR . $_SESSION['course_id'] . $current_file;
...
if (file_exists($real) && (substr($real, 0, strlen(AC_TEMP_DIR)) == AC_TEMP_DIR)) {
	if ($force_download) {
